...
import { User, Mail, Phone, Edit2, Save, X, LogOut, Shield } from 'lucide-react'
          ...
          <div className="flex items-end gap-4">
            <div className="w-32 h-32 bg-white rounded-full border-4 border-white shadow-lg flex items-center justify-center">
              <div className="w-28 h-28 bg-red-100 rounded-full flex items-center justify-center">
                <User className="h-14 w-14 text-red-600" />
              </div>
            </div>
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6 space-y-3">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-gray-900 font-medium">Full System Access</span>
          </div>
        </div>
      </div>
